...
//Задание 2
//
//Создай объекты рабочей группы так, чтобы у CTO был PM и CRM, у PM было два
//тим-лида (на фронт и бэк) и у каждого было по группе сотрудников подходящего
//для его стека профиля.
