...
// Новый абстрактный класс для программируемого оборудования
abstract class ProgrammableDevice : PoweredDevice(), Programmable {
    override fun programAction(action: String) = println("${this::class.simpleName} запрограммирован на действие: $action")
    override fun execute() = println("${this::class.simpleName} выполняет запрограммированное действие")
}

// Реализация всех устройств с println

// Абстрактный базовый класс
abstract class PoweredDevice1 : Powerable {
    override fun powerOn() = println("${this::class.simpleName} включено")
    override fun powerOff() = println("${this::class.simpleName} выключено")
}

// 1. Refrigerator -------------------------------------------------
class MyRefrigerator1 : Refrigerator() {
...
// 4. DigitalClock ---------------------------------------------------
class MyDigitalClock1 : DigitalClock() {
...
// 5. RobotVacuum ----------------------------------------------------
class MyRobotVacuum1 : RobotVacuum() {
...
// 8. CoffeeMachine --------------------------------------------------
class MyCoffeeMachine1 : CoffeeMachine() {
...
// 9. SmartSpeaker ---------------------------------------------------
class MySmartSpeaker1 : SmartSpeaker() {
