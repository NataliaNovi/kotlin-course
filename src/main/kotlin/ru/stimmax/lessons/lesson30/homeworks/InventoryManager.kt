...
//Скопируй к себе класс и напиши по несколько unit тестов на
//каждый метод, чтобы проверить его работоспособность.
//Найди с помощью тестов ошибки в коде и исправь их.
//Должно получиться по меньшей мере 12 тестов.
